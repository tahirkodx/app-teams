<template>
  <Header is-back-button router-link="teamStatus" />
  <ion-content :fullscreen="true">
    <ion-grid>
      <ion-row>
        <ion-col>
          <h4 class="titleStyle">List Of Excercises</h4>
        </ion-col>
      </ion-row>
      <SearchBar />
    </ion-grid>
              ...
              <ion-accordion-group>
                <ion-accordion value="first">
                  <ion-item slot="header" color="light">
                    <ion-label class="ion-color">Frequency</ion-label>
                  </ion-item>
                  <div slot="content">
                    <ion-list>
                      <ion-radio-group>
                ...
                <ion-accordion value="second">
                  <ion-item slot="header" color="light">
                    <ion-label class="ion-color">Choice</ion-label>
                  </ion-item>
                  <div slot="content">
                    <ion-list>
                      <ion-radio-group>
                ...
                <ion-accordion value="thrid">
                  <ion-item slot="header" color="light">
                    <ion-label class="ion-color">Date</ion-label>
                  </ion-item>
                  <div slot="content">
                    <ion-list>
                      <ion-item>
...
import Date from "@/components/Widgets/DatePicker.vue";
