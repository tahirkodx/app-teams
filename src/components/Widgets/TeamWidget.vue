<template>
  <div class="custom-card-container" @click="scrollLeft" ref="cardContainer">
...
onMounted(() => {
  // Optional: setup touch gestures if needed
});
</script>
...
ion-card-content {
  ...
  padding-top: 16px; /* Additional padding at the top */
  font-size: 1rem;
}
