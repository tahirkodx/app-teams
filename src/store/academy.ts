...
const useAcademyStore = defineStore("Academy", () => {
  ...
  async function getCourses(teamId: any) {
    // console.log("Here is team id " , teamId)
    // todo need to change team id 
    const payload = {
      teamId : "cbb7c36a565e4dc1956f8aab507aa140"
    }
    courses.value = await AcademyAPI.getCourses(payload);
