...
import VideoPlayerModal from '@/components/VideoPlayerModal/VideoPlayerModal.vue';
import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name, resources, openModal, selectedResource } from "./Academy.vue";
...
__VLS_WithComponent<'VideoPlayerModal', typeof __VLS_localComponents, "VideoPlayerModal", "VideoPlayerModal", "VideoPlayerModal">;
...
__VLS_components.VideoPlayerModal;
// @ts-ignore
[VideoPlayerModal,];
{
...
{
const __VLS_97 = ({} as 'VideoPlayerModal' extends keyof typeof __VLS_ctx ? { 'VideoPlayerModal': typeof __VLS_ctx.VideoPlayerModal; } : typeof __VLS_resolvedLocalAndGlobalComponents).VideoPlayerModal;
const __VLS_98 = __VLS_asFunctionalComponent(__VLS_97, new __VLS_97({ ...{}, resource: ((__VLS_ctx.selectedResource)), isOpen: ((!!__VLS_ctx.selectedResource)), }));
({} as { VideoPlayerModal: typeof __VLS_97; }).VideoPlayerModal;
const __VLS_99 = __VLS_98({ ...{}, resource: ((__VLS_ctx.selectedResource)), isOpen: ((!!__VLS_ctx.selectedResource)), }, ...__VLS_functionalComponentArgsRest(__VLS_98));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_97, typeof __VLS_99> & Record<string, unknown>) => void)({ ...{}, resource: ((__VLS_ctx.selectedResource)), isOpen: ((!!__VLS_ctx.selectedResource)), });
...
// @ts-ignore
[router, selectedResource, selectedResource, selectedResource, selectedResource, selectedResource, selectedResource, selectedResource,];
}
