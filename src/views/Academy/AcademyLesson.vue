<template>
  <ion-page>
    ...
    <ion-content>
      ...
      <div class="header-container">
        ...
        <ion-row class="pl-4">
          ...
          <div class="ion-text-end text-course flex font-xs" id="open-modal"><span>Course Details</span> <ion-icon
    ...
    <ion-modal trigger="open-modal" :initial-breakpoint="1" :breakpoints="[0, 1]" ref="modalRef">
      <ion-content>
        <div>
          <div class="header-container">
            <ion-row>
            ...
            <ion-col>
              <div v-for="(topic, index) in lessonTopics" :key="index"
                ...
                <div class="ion-padding-horizontal">
                  ...
                  <ion-progress-bar :style="{ color: topic.progressColor }" :value="topic.progress"></ion-progress-bar>
              ...
              <div>
                <ion-label class="text-bold ion-padding">Course Description:</ion-label>
                ...
                <ion-accordion value="first">
                  ...
                  <div class="lesson-div" slot="content">
                    <ion-list lines="none" class="ion-no-padding ion-no-margin">
                      <ion-item v-for="(lesson, index) in lessonList" :key="index" class="ion-no-padding ion-no-margin">
                        <ion-label class="ion-no-padding ion-no-margin lesson-label">
                          <ion-icon :icon="play" color="primary"></ion-icon> {{ lesson.title }}
                        </ion-label>
                      </ion-item>
                    </ion-list>
                  </div>
...
//   this.$refs.modalController.dismiss();
// };
