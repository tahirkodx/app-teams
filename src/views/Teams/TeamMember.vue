  ...
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <div class="title-container">
        ...
        >
          ...
          >
            <ion-content>
              <ion-list lines="none">
                <ion-item :button="true" @click="teamAction('edit')" :detail="false">
                  <ion-icon icon="/src/pictures/mdi_edit.svg"> </ion-icon>
                  Edit</ion-item
                >
                <ion-item :button="true" @click="teamAction('delete')" :detail="false">
                  <ion-icon icon="/src/pictures/fluent_delete-20-filled.svg">
                  </ion-icon
                  >Delete</ion-item
                >
                <ion-item :button="true" @click="teamAction('leave')" id="nested-trigger">
                  <ion-icon
      ...
      <div class="scrollable-list">
        <ion-list>
          <ion-item v-for="(member, index) in teamStore?.teamMembers?.members" :key="index" lines="full">
            ...
            <ion-button slot="end" >
              {{ member.role === 1 ? "Member" : member.role === 2 ? "Leader" : member.role === 3 ? "Coach" : "Visitor" }}
            </ion-button>
