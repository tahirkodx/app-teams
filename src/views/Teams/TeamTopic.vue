<template>
    <ion-page>
        ...
        <ion-content>
            <ion-text>
                <h2 class="text-lg ion-padding-start ion-padding-bottom">Build Their group Identity</h2>
            </ion-text>
            <InfoCard />
            <!-- 
            ...
            <ion-text class="bg-gray owner-container font-sm ion-padding-start ion-padding-end">
                ...
                <div class="container text-center"> <ion-button id="top-center" class="font-normal">Build Their Group
                        Identity <ion-icon :icon="chevronDownOutline" class="ion-margin-start"></ion-icon><span
                    ...
                    <ion-grid>
                        <ion-row>
                            <ion-col class="ion-padding">
                                <ion-card v-for="(card, index) in cardArray" :key="index"
                                    ...
                                    <div class="ggh">
                                        ...
                                        <div>
                                            <ion-card-header>
                                                <ion-card-title class="text-bold">{{ card.title }}</ion-card-title>
                                                <div class="owner-container font-sm">
                                                    ...
                                                    <h3 class="text-small">
                                                        ...
                                                        <span :class="{ 'success': card.ongoing }"> Ongoing </span>
                                                    </h3>
                                                </div>
                                            </ion-card-header>
